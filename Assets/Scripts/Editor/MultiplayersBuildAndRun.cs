...
public static class MultiplayersBuildAndRun {
	[MenuItem("Multiplayer/Windows/1 Player")]
	static void PerformWin64Build1() {
		PerformWin64Build(1);
	}

	[MenuItem("Multiplayer/Windows/2 Players")]
	static void PerformWin64Build2 (){
		PerformWin64Build (2);
	}

	[MenuItem("Multiplayer/Windows/3 Players")]
	static void PerformWin64Build3 (){
		PerformWin64Build (3);
	}

	[MenuItem("Multiplayer/Windows/4 Players")]
	...
	[MenuItem("Multiplayer/Mac OSX/1 Players")]
	static void PerformOSXBuild1() {
		PerformOSXBuild(1);
	}

	[MenuItem("Multiplayer/Mac OSX/2 Players")]
	static void PerformOSXBuild2 (){
		PerformOSXBuild (2);
	}

	[MenuItem("Multiplayer/Mac OSX/3 Players")]
	static void PerformOSXBuild3 (){
		PerformOSXBuild (3);
	}

	[MenuItem("Multiplayer/Mac OSX/4 Players")]
